...
class DetailProductPosView extends StatefulWidget {
  const DetailProductPosView({
    super.key,
  ...
  @override
  State<DetailProductPosView> createState() => _DetailProductPosViewState();
}

class _DetailProductPosViewState extends State<DetailProductPosView> {
  String token = "";
          ...
          : Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CheckoutRowViwe(
                    title: "Costs",
                    value: dataSales['costs'].toString(),
                  ),
                  const Divider(color: Colors.grey, height: 1),
                  CheckoutRowViwe(
                    title: "Discount",
                  ...
                  CheckoutRowViwe(
                    title: "Payment",
                    value: dataSales['payment_type'].toString(),
                  ),
                  const Divider(color: Colors.grey, height: 1),

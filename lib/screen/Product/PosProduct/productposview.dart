...
import 'package:rsnaturopaty/screen/Product/PosProduct/CheckOutProductPos.dart';
import 'package:rsnaturopaty/screen/Product/PosProduct/detailProductPos.dart';
...
class ProductPosNew extends StatefulWidget {
  const ProductPosNew({super.key});

  @override
  State<ProductPosNew> createState() => _ProductPosNewState();
}

class _ProductPosNewState extends State<ProductPosNew> {
  List productList = [];
  ...
  getProdukList() async {
    ...
    try {
      var resBody =
          '{"limit": 30, "offset": "", "orderby": "", "order": "asc", "pos":"1"}';
